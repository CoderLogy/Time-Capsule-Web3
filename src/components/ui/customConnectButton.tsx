      ...
      {({
        ...
        return (
          <Button
            ...
            className="border-primary/80 bg-slate-400/15 text-primary text-xs rounded-xl  px-1 sm:px-3 md:px-4 py-4 hover:bg-primary/80 active:scale-95 hover:text-white transition-all cursor-pointer ease-linear duration-300"
          >
            <div className="flex items-center gap-3">
