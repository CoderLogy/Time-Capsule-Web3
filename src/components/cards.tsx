...
import ViewCapsuleModal from "./ViewCapsuleModal.tsx";
    ...
    return (
        ...
        >
            <div className="flex items-start justify-between mb-4 relative z-10">
                ...
                <span className="shrink-0 inline-flex rounded-full items-center gap-1 bg-slate-200 group-hover/card:bg-slate-300 px-2.5 py-1 text-sm font-medium text-gray-500 uppercase transition-colors duration-200 ease-linear">
                    Locked
                </span>
            </div>
    ...
    return (
        <div className="bg-white/80 rounded-2xl p-5 hover:shadow-lg border border-gray-200 cursor-pointer transition-all duration-200 transform hover:-translate-y-1 hover:-translate-x-1 relative overflow-hidden group/card shrink-0">
            <div className="flex items-start justify-between mb-4 relative z-10 transition-all duration-200">
                ...
                <span className="shrink-0 inline-flex rounded-full items-center gap-1 bg-green-100 group-hover/card:bg-green-200 text-green-600 px-2.5 py-1 text-sm font-medium uppercase transition-colors duration-200 ease-linear">
                    Ready
                </span>
            </div>
    ...
    return (
        <div className="bg-white/80 rounded-2xl p-5 border-gray-100 transition-all duration-200 relative overflow-hidden group/card shrink-0">
            <div className="flex items-start justify-between mb-4 relative z-10">
                ...
                <span className="shrink-0 inline-flex rounded-full items-center gap-1 px-2.5 py-1 text-sm font-medium text-yellow-600 bg-yellow-100 uppercase">
                    Pending
                </span>
            </div>
        ...
        >
            <AnimatePresence>
                ...
                {capsules.length === 0 && pendingTitles.length === 0 && (
                    <p className="text-sm text-gray-400 text-center mt-8">No capsules yet.</p>
                )}
