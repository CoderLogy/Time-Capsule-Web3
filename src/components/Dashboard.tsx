...
export default function Dashboard() {
  ...
  const handleCreateCapsule = async () => {
    ...
    if (!isConnected)
      return (toast.error("Wallet not connected"), window.location.reload());
    ...
    try {
      ...
      console.log(
        ...
        "overflow:",
        getComputedStyle(container).overflowY,
      );
    }
  };
    ...
    <div>
      ...
      <div className="pt-30 text-center py-8 flex flex-col items-center gap-4 md:gap-6">
        ...
        <p className="text-foreground text-base md:text-xl max-w-2xl tracking-tight px-2">
          A decentralized time capsule for your digital assets. Securely encrypt
          messages and media today, unlock them on a date you choose.
        </p>
        <div className="flex flex-col lg:flex-row gap-8 px-6 md:px-25 w-full mx-auto">
          <div className="w-full lg:w-7/12">
            <div className="bg-white/80 my-4 rounded-2xl p-5 md:p-8 relative z-10">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-xs md:text-sm">
                    Seal a message on the blockchain.
                  </p>
                </div>
                <Button
              ...
              <div
                className={`flex justify-around items-center w-full text-xs md:text-sm gap-1 ${!isConnected ? "select-none pointer-events-none blur-[3px]" : ""}`}
              >
                <div className=" bg-background/60 shadow-inner flex items-center h-8.5 mx-1/2 px-4 py-1.75 rounded-full">
              ...
              <div
                className={`px-4 py-4 md:py-5 ${!isConnected ? "mt-8 select-none pointer-events-none opacity-50  blur-[1.8px]" : ""}`}
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 resize-none">
                  <div>
                    <Label
                      htmlFor="CapsuleTitle"
                      className="text-sm mb-2 ml-2 tracking-wider"
                    >
                      Title
                    </Label>
                    <Input
                      ...
                      className="text-sm h-12 rounded-xl border focus:border-2 border-gray-300 shadow-sm w-full focus:scale-102"
                    />
                  </div>
                  <div>
                    <Label
                      htmlFor="CapsuleDatePicker"
                      className="text-sm mb-2 ml-2 tracking-wide"
                    >
                      Unlock Date
                    </Label>
                  ...
                  <div className="col-span-0 sm:col-span-2">
                    ...
                    <Textarea
                      ...
                      className="h-32 text-sm rounded-xl border focus:border-2 border-gray-300 shadow-sm w-full px-4 py-3 overflow-auto resize-none focus:scale-102"
                    />
                  </div>
                </div>
              </div>
        ...
        <footer className="mt-auto py-6 border-t border-gray-600/60">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
            <a
              ...
              className="hover:text-accent transition-colors ease-in-out duration-400"
            >
